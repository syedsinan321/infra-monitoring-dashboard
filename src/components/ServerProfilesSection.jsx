...
import { FileText, Check, X, Server, ChevronDown, ChevronRight, Box, Cpu } from 'lucide-react';
...
function ServerProfilesSection({ profiles, blades, chassis }) {
  ...
  // Group profiles by chassis (full chassis name like site1nonprducs01-2)
  const groupProfilesByChassis = () => {
    ...
    profiles.forEach((profile) => {
      ...
      if (blade && blade.chassis_name) {
        // Use full chassis name (e.g., site1nonprducs01-2)
        ...
        // Assigned but blade not found - put in "Other" group
        if (!groups['Other']) {
          groups['Other'] = {
            name: 'Other',
            profiles: [],
